...
| Evidence emit | `scripts/emit-photoreal-evidence.mjs` | PEP/SPR/CEC + T-01..T-08 |
| Certify CLI | `scripts/photoreal-certify.mjs` | CPCS (**broken export wire**) |
| Promote CLI | `mrs:photoreal-promote` / `promotionPipeline.js` | **missing on disk** |

## Stub honesty

No new stubs created. Missing promote pipeline is recorded as a gap, not scaffolded in this verification cycle.
