    ...
    def add_artifact(
        ...
        with self._get_conn() as conn:
            ...
            conn.execute(
                ...
                (datetime.utcnow().isoformat() + "Z", bundle_id),
            )
...
def create_evidence_store(db_path: Path = Path("./data/evidence.db")) -> SQLiteEvidenceStore:
    """Factory function to create evidence store"""
